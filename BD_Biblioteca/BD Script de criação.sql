...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Bibliotecadb`.`LivrosPorEditora` (`Editora` INT, `Livro` INT);

-- -----------------------------------------------------
-- Placeholder table for view `Bibliotecadb`.`LivrosPorCategoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Bibliotecadb`.`LivrosPorCategoria` (`Categoria` INT, `Livro` INT);

-- -----------------------------------------------------
-- Placeholder table for view `Bibliotecadb`.`LivrosPorAno`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Bibliotecadb`.`LivrosPorAno` (`Ano` INT, `Livro` INT);

-- -----------------------------------------------------
-- Placeholder table for view `Bibliotecadb`.`LivrosPorAutor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Bibliotecadb`.`LivrosPorAutor` (`Autor` INT, `Livro` INT);
...
SELECT l.Editora AS Editora, l.Titulo AS Livro
FROM Livros l
...
SELECT c.Descricao AS Categoria, l.Titulo AS Livro
FROM Livros l
...
SELECT l.AnoDeLancamento AS Ano, l.Titulo AS Livro
FROM Livros l
...
USE `Bibliotecadb`$$
CREATE DEFINER = CURRENT_USER TRIGGER `Bibliotecadb`.`Reservas_BEFORE_INSERT` BEFORE INSERT ON `Reservas` FOR EACH ROW
BEGIN

UPDATE usuarios
SET qntlivros = qntlivros + 1
WHERE codusuarios = new.usuario_codusuario;
